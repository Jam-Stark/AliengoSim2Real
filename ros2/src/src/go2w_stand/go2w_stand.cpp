...
void LowLevelCmdNode::LowStateMessageHandler(
  ...
  std::cout << "Imu quat : " << "w: " << low_state_.imu_state.quaternion[0]
            << " x: " << low_state_.imu_state.quaternion[1]
            << " y: " << low_state_.imu_state.quaternion[2]
            << " z: " << low_state_.imu_state.quaternion[3] << std::endl;
  std::cout << std::endl;
}
