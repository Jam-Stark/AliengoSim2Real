...
- `memory/a2_deploy_progress/`
  ...
  - 覆盖 `a2_lowlevel` package、A2 low-level interface、smoke node、deploy machine info collector、部署机验证 TODO。

## Routing

- A2 标准版 ROS2 low-level control、`unitree_hg`、`rt/lowstate`、`rt/lowcmd`、A2 deploy machine readiness，先读 `memory/a2_deploy_progress/description.md`。
